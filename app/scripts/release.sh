...
#
#   app/scripts/release.sh <patch|minor|major|X.Y.Z> [--dry-run] [--yes]
#
...
usage() { echo "usage: app/scripts/release.sh <patch|minor|major|X.Y.Z> [--dry-run] [--yes] [--notes=FILE]"; exit 2; }
